...
namespace BrowserAutomationPlugin.Helpers
{
    ...
    public static class WebDriverHelper
    {
        ...
        public static IWebElement WaitForElementWithAttribute(IWebDriver driver, string search, SelectorType selectorType,
        ...
        public static bool WaitForElementToAppear(IWebDriver driver, string search, SelectorType selectorType, int timeoutInSeconds)
        {
            var wait = new DefaultWait<IWebDriver>(driver)
            {
                Timeout = TimeSpan.FromSeconds(timeoutInSeconds),
        ...
        public static bool WaitForElementToDisappear(IWebDriver driver, string search, SelectorType selectorType, int timeoutInSeconds)
        {
            var wait = new DefaultWait<IWebDriver>(driver)
            {
                Timeout = TimeSpan.FromSeconds(timeoutInSeconds),
